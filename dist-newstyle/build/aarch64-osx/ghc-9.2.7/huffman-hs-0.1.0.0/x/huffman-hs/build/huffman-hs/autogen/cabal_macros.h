...
/* package huffman-hs-0.1.0.0 */
#ifndef VERSION_huffman_hs
#define VERSION_huffman_hs "0.1.0.0"
#endif /* VERSION_huffman_hs */
#ifndef MIN_VERSION_huffman_hs
#define MIN_VERSION_huffman_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_huffman_hs */
...
#define CURRENT_COMPONENT_ID "huffman-hs-0.1.0.0-inplace-huffman-hs"
